...
urlpatterns = [
   ...
   path('(?P<id>\d+)/editOrder/', order_update, name = "order_edit"),
   path('(?P<id>\d+)/deleteOrder/', order_delete, name = "order_delete"),
   path('create/', car_created, name = "car_create"),
   path('message/', admin_msg, name='message'),
   path('(?P<id>\d+)/deletemsg/', msg_delete, name = "msg_delete"),
